...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold cyan](11): Unlock Paid Cars + Siren ~ FREE[/bold cyan]")
            console.print("[bold cyan](12): Unlock w16 Engine ~ FREE[/bold cyan]")
            ...
            console.print("[bold cyan](16): Unlock House 3 ~ FREE[/bold cyan]")
            console.print("[bold cyan](17): Unlock Smoke ~ FREE[/bold cyan]")
            console.print("[bold cyan](18): Change Race Wins ~ 1K[/bold cyan]")
            console.print("[bold cyan](19): Change Race Loses ~ 1K[/bold cyan]")
            console.print("[bold cyan](20): Clone Account ~ FREE[/bold cyan]")
            console.print("[bold cyan](21): Unlock all Cars ~ FREE[/bold cyan]")
